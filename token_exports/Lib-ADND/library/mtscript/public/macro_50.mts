...
[h:status = input(
	strformat("seperator|<html><b>--- PCs:%{pcNames} ---</b></html> | | LABEL | SPAN=TRUE"),
	strformat("seperator|<html><b>--- Individual Awards ---</b></html> | | LABEL | SPAN=TRUE"),
	strformat("perUserEXP| 0 | Granted EXP per PC")
)]
[H: abort(status)]

[h: pcTotalEXP = perUserEXP]
[foreach(pcToken,pcList,""), code :{
