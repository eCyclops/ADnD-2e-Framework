...
[h, macro("getArmorSaveAdjust@Lib:Equipment:Macros"): strformat("myID=%{myID}")]
[h: armorSaveAdj = macro.return]
...
[foreach(id,currentSelections,""), code :{
	...
	[h: rolledSave = 1d20]
	[h,if(overRide>0 && overRide<=20):finalCheck=overRide;finalCheck = rolledSave+saveAdjustment+abilityMod+armorSaveAdj]

	[h:saveRollToolTip = toolTipIt(strformat("1d20 + Modifiers + Ability Modifiers + Magic Armor Adjustment, %{rolledSave}+%{saveAdjustment}+%{abilityMod}+%{armorSaveAdj}=%{finalCheck}"),finalCheck)]
