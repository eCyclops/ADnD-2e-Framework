...
<div>
  [h: rollInitiativeLink =  macroLink("Roll Initiative",'DO_Initiative@Lib:ADND','none',strformat("myID=%{myID};"),myID)]
  [h: multiAttackLink =  macroLink("Multiple Weapons",'getMultiWeaponSelectionForm@Lib:ADND','none',strformat("myID=%{myID};"),myID)]
  [r: rollInitiativeLink], or attack with <span title="Attack with multiple weapons. Longsword/Shortsword, Dagger/Dagger, etc.">[r: multiAttackLink]</span>
</div>
<div>
  <h2>[r: attacksIMG]Attacks</h2>
  [r, macro("Mod:Attacks@this"): strformat('myID=%{myID};')]
</div>
